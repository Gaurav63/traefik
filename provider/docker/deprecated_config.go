...
func (p *Provider) buildConfigurationV1(containersInspected []dockerData) *types.Configuration {
	var DockerFuncMap = template.FuncMap{
		...
		"getStickinessCookieCipherKey": getFuncStringLabelV1(label.TraefikBackendLoadBalancerStickinessCookieCipherKey, label.DefaultBackendLoadbalancerStickinessCookieCipherKey),
		"getStickinessCookieMaxAge":    getFuncIntLabelV1(label.TraefikBackendLoadBalancerStickinessCookieMaxAge, label.DefaultBackendLoadbalancerStickinessCookieMaxAge),
