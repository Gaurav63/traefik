...
const (
	...
	SuffixBackendLoadBalancerStickinessCookieMaxAge             = SuffixBackendLoadBalancer + ".stickiness.cookieMaxAge"
	SuffixBackendLoadBalancerStickinessCookieCipherKey          = SuffixBackendLoadBalancer + ".stickiness.cookieCipherKey"
