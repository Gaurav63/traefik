...
var compatibilityMapping = map[string]string{
	...
	annotationKubernetesSessionCookieCipherKey:   "traefik.backend.loadbalancer.stickiness.cookieCipherKey",
	annotationKubernetesSessionCookieMaxAge:      "traefik.backend.loadbalancer.stickiness.cookieMaxAge",
